...
execute if entity @s[tag=aj.cosody.animation.button.down.animation.playing] run function animated_java:cosody/animations/button.down.animation/zzz/on_tick
