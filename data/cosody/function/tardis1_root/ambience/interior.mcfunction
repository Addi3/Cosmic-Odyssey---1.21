...
#interior
execute if score tardis1in/exterior tardis1_timers matches 500 run playsound minecraft:ship_ambience1 ambient @a[tag=inside] ~ ~ ~ 10 1 1
execute if score tardis1in/exterior tardis1_timers matches 1 run playsound minecraft:ship_ambience2 ambient @a[tag=inside] ~ ~ ~ 5 1 1
...
execute if score tardis1in/exterior tardis1_timers matches 1000 run playsound minecraft:ship_ambience3 ambient @a[tag=inside] ~ ~ ~ 5 1 1
...
execute if score tardis1in/exterior tardis1_timers matches 200 run playsound minecraft:ship_ambience3 ambient @a[tag=inside] ~ ~ ~ 5 1 1
execute if score tardis1in/exterior tardis1_timers matches 700 run playsound minecraft:ship_ambience4 ambient @a[tag=inside] ~ ~ ~ 8 1 1
