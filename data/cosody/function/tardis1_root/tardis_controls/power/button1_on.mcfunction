...
execute if score @p tardis1_trust matches 1.. if score button1_on tardis1 matches 0 at @e[tag=button1int] run playsound minecraft:buttonpush ambient @p[tag=inside1,distance=..5] ~ ~ ~ 2 1 1
