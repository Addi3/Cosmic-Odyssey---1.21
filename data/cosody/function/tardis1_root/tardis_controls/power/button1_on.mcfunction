...
execute if score @p tardis1_trust matches 1.. if score button1_on tardis1 matches 0 at @e[tag=console] run playsound minecraft:buttonpush ambient @p[distance=..5] ~ ~ ~ .5 1 1
