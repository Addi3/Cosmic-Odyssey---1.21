...
execute if score @p tardis1_trust matches 1.. if score key_on tardis1 matches 0 at @e[tag=console] run playsound minecraft:block.stone_button.click_on ambient @p[tag=inside1,distance=..5] ~ ~ ~ .5 .9 1
