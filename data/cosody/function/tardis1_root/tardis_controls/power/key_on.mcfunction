...
execute if score @p tardis1_trust matches 1.. if score key_on tardis1 matches 0 at @e[tag=key1int] run playsound minecraft:block.stone_button.click_on ambient @p[tag=inside1,distance=..5] ~ ~ ~ 2 .9 1
