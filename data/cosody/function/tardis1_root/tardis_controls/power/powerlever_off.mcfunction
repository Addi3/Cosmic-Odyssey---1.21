...
execute if score @p tardis1_trust matches 1.. if score powerlever_on tardis1 matches 1 at @e[tag=console] run playsound minecraft:lever2 ambient @p[distance=..5] ~ ~ ~ .5 .9 1
