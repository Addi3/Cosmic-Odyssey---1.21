...
execute if score @p tardis1_trust matches 1.. if score powerlever_on tardis1 matches 0 at @e[tag=console] run playsound minecraft:lever2 ambient @p[tag=inside1,distance=..5] ~ ~ ~ .5 1 1
